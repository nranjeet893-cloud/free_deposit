...
def main():
    ...
    # ── Step 1: BOT_TOKEN check (sabse pehle) ──────────────
    ...
    # ── Step 4: Bot start with auto-restart ───────────────
    # FIX: Application ek baar banao — har crash pe NAYA mat banao.
    # PTB v20 mein Application ke andar Updater ka __slots__ hota hai;
    # naya object banane se '_Updater__polling_cleanup_cb' AttributeError aata hai.
    # Solution: asyncio loop use karo, sirf polling restart karo, Application nahi.
