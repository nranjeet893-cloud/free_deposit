...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # ✅ FIX: /start pe hamesha welcome screen + channels dikhao
        # Chahe user pehle se join kar chuka ho — channels HIDE nahi honge
        # Deposit screen sirf "Verify" button click karne pe aayega
        channels_to_show = not_joined if not_joined else ch1_list
        ...
        kb = kb_force_join(channels_to_show, cfg)
