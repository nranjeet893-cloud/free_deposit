...
def init_db():
    with _conn() as c:
        ...
        c.execute("UPDATE config SET value='naam_only' WHERE key='join_btn_style'")
...
def _join_btn_label(ch, cfg):
    ...
    - naam_only  → sirf channel naam (clean, koi prefix nahi)
    ...
    if style == "naam_arrow":
        ...
        return name  # naam_only — bilkul clean sirf naam
